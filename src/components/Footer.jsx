...
const Footer = () => {
  return (
    <React.Fragment>
    <div className='max-w bg-[#64c1ff] mx-auto py-0 px-3 grid lg:grid-cols-3 gap-6 text-black'>
      <div>
        <h1 className='w-full text-3xl font-bold text-[#000000]'>Resume Assisted</h1>
