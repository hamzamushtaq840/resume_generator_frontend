...
const Companies = () => {
    ...
    <div>
    <h1 className=" pl-2 text-5xl font-extrabold text-center ">Companies Like
      <Typed
 ...
 <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
     ...
     hover:scale-105 duration-300'>
         <img className='w-20 mx-auto mt-[-3rem] bg-transparent' src={facebook}ingle alt="/" />
     ...
     <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
         <img className='w-20 mx-auto mt-[-3rem] bg-transparent' src={microsoft} alt="/" />
         ...
         <button
             className="bg-[#64c1ff] w-[200px] hover:text-blue-500 hover:bg-white rounded-md font-medium my-6 mx-auto px-6 py-3">JOBS
          </button>
         
     </div>
     <div className='w-full shadow-xl bg-black-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
         <img className='w-20 mx-auto mt-[-3rem] bg-transparent' src={amazon} alt="/" />
